...
with tab4:
    ...
    **التقنيات المستخدمة:**
    ...
    - نموذج EfficientNetB0 مع Transfer Learning وFocal Loss
    - قاعدة بيانات SQLite (9 جداول مترابطة)
    - واجهة استخدام Streamlit

    **حالة المشروع:** النموذج مدرَّب فعلياً على بيانات HAM10000 الحقيقية
    (10,015 صورة)، بدقة تصنيف إجمالية 82% على بيانات التحقق، ضمن المدى
    المرجعي للدراسات العلمية المنشورة على نفس المجموعة (80%-96%).
    """
    )
